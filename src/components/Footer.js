...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-purple-500 text-primary-content mt-32">
            <div>
                ...
                <p className="font-bold text-lg pt-1">
                    Todo Task Ltd. <br />Providing reliable tech since 1992
                </p>
                <p className='text-lg'>Copyright © 2022 Todo Task. All rights reserved.</p>
            </div>
            <div>
